...
function addTouchInteractions() {
    ...
    stationButtons.forEach(button => {
        ...
        button.addEventListener('touchend', function(e) {
            ...
            this.style.transform = 'scale(1)';
            this.style.transition = 'transform 0.2s ease';
            this.style.background = 'linear-gradient(135deg, #6a5acd 0%, #8a7aed 100%)';
...
function addDashboardTouchInteractions() {
    ...
    statCards.forEach(card => {
        card.addEventListener('touchstart', function(e) {
            ...
            this.style.transition = 'transform 0.1s ease';
            this.style.borderColor = 'rgba(106, 90, 205, 0.8)';
            this.style.boxShadow = '0 25px 50px rgba(106, 90, 205, 0.4)';
        });

        card.addEventListener('touchend', function(e) {
            this.style.transform = 'translateY(0) scale(1)';
            this.style.transition = 'transform 0.2s ease';
            this.style.borderColor = 'rgba(106, 90, 205, 0.3)';
...
function addFooterTouchInteractions() {
    ...
    footerContactItems.forEach(item => {
        item.addEventListener('touchstart', function(e) {
            ...
            this.style.borderColor = 'rgba(106, 90, 205, 0.6)';
        });
        ...
        item.addEventListener('touchend', function(e) {
            ...
            this.style.borderColor = 'rgba(106, 90, 205, 0.2)';
        });
    ...
    socialLinks.forEach(link => {
        link.addEventListener('touchstart', function(e) {
            ...
            this.style.background = 'rgba(106, 90, 205, 0.3)';
            this.style.borderColor = 'rgba(106, 90, 205, 0.6)';
            this.style.boxShadow = '0 12px 25px rgba(106, 90, 205, 0.5)';
        });
